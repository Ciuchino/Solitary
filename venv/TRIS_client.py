...
clientSocket.send(sorteggio.encode('utf-8'))#   Inviamo la scelta del sorteggio al server
...
while 1:
    print('|1A|1B|1C|\n|2A|2B|2C|\n|3A|3B|3C|\n')
    if PC_turn == False:
        PC_turn = True # La prossima mossa e` dell'utente
    else:
        PC_turn = False #La prossima mossa sara` del PC
        while 1:
